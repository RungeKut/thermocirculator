...
extern volatile uint8_t NbDataOnPage;
...
void flashPage_write32data(uint16_t Page, uint8_t Nbdata, uint32_t data );
uint8_t flashPage_Init(uint16_t);
uint32_t flashPage_read32(uint16_t, uint8_t);
