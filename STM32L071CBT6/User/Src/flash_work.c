...
volatile uint8_t NbDataOnPage = 1; //Номер переменной на странице
...
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓*/
//Пишем следующую 32bit переменную на страницу. Их всего 32                           ┃
...
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓*/
//Пишем 32bit переменную на страницу. Их всего 32                           ┃
void flashPage_write32data(uint16_t Page, uint8_t Nbdata, uint32_t data )//32 bit word             ┃
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛*/
{
  if (Nbdata > 32) return;
	uint32_t temp = flashPage_read32(Page, Nbdata);
	if ( temp == data ) return;
	if ( temp == 0 ){
		if ( data == 0 ) return;
		flash_ok = HAL_ERROR;
		while(flash_ok != HAL_OK)
		{
			flash_ok = HAL_FLASH_Program(FLASH_TYPEPROGRAM_WORD, flashPage_addr(Page)+((Nbdata-1)*0x4), (uint32_t)data);
		}
	}
	else{
		uint32_t buf[32] = {0};
		for( uint8_t i = 0; i < 32; i++ ){
			buf[i] = flashPage_read32(Page, i);
		}
		flashPage_erase(Page, 1);
		buf[Nbdata - 1] = data;
		for( uint8_t j = 0; j < 32; j++ ){
			flashPage_write32data(Page, j, buf[j]);
		}
  }
}
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓*/
...
uint8_t flashPage_Init(uint16_t Page)//                                     ┃
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛*/
{
...
uint32_t flashPage_read32(uint16_t Page, uint8_t NbData)//                  ┃
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛*/
{
