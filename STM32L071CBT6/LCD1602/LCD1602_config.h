...
*/
		...
		// при этом если их также назвали в CubeMX то указывать ненужно -------------------------------------
			...
			#ifndef RS_GPIO_Port
				#define RS_GPIO_Port   		DISP_RS_GPIO_Port
				#define RS_Pin				DISP_RS_Pin
			#endif
			//--------------------------------------------------------------------
			// указываем пин Еnable (строб по спаду) -----------------------------
			#ifndef E_GPIO_Port
				#define E_GPIO_Port   		DISP_E_GPIO_Port
				#define E_Pin				DISP_E_Pin
			#endif
			//--------------------------------------------------------------------
			// указываем пин DB4 - линия данных	(используем в 4 битном режиме )---
			#ifndef DB4_GPIO_Port
				#define DB4_GPIO_Port   	DISP_DB4_GPIO_Port
				#define DB4_Pin				DISP_DB4_Pin
			#endif
			//--------------------------------------------------------------------
			// указываем пин DB5 - линия данных	(используем в 4 битном режиме )---
			#ifndef DB5_GPIO_Port
				#define DB5_GPIO_Port   	DISP_DB5_GPIO_Port
				#define DB5_Pin				DISP_DB5_Pin
			#endif
			//--------------------------------------------------------------------
			// указываем пин DB6 - линия данных	(используем в 4 битном режиме )---
			#ifndef DB6_GPIO_Port
				#define DB6_GPIO_Port   	DISP_DB6_GPIO_Port
				#define DB6_Pin				DISP_DB6_Pin
			#endif
			//--------------------------------------------------------------------
			// указываем пин DB7 - линия данных	(используем в 4 битном режиме )---
			#ifndef DB7_GPIO_Port
				#define DB7_GPIO_Port   	DISP_DB7_GPIO_Port
				#define DB7_Pin				DISP_DB7_Pin
			#endif
			//--------------------------------------------------------------------
		#endif
